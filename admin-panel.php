    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          ...
          if($query)
          {
            echo "<script>alert('Votre rendez-vous a bien été réservé');</script>";
          }
          else{
            echo "<script>alert('Impossible de traiter votre demande. Veuillez réessayer!');</script>";
          }
      }
      else{
        echo "<script>alert('Nous sommes désolés de vous informer que le médecin n'est pas disponible à cette heure ou à cette date. Veuillez choisir une heure ou une date différente!');</script>";
      }
    }
    else{
      echo "<script>alert('Sélectionnez une heure ou une date dans le futur!');</script>";
    }
  }
  else{
      echo "<script>alert('Sélectionnez une heure ou une date dans le futur!');</script>";
...
if(isset($_GET['cancel']))
  {
    ...
    if($query)
    {
      echo "<script>alert('Votre rendez-vous a bien été annulé');</script>";
    }
  }
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Glissa Hopital</h2></br>
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Se déconnecter</a>
      </li>
       <li class="nav-item">
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Prendre rendez-vous</a>
      <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">Historique des rendez-vous</a>
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Réservez mon rendez-vous</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Mes rendez-vous</h2>
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Créer un rendez-vous</h4></center><br>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                          <select name="spec" class="form-control" id="spec">
                              <option value="" disabled selected>Sélectionnez la spécialisation</option>
                              <?php 
                              display_specs();
                              ?>
                          </select>
              ...
              <div class="col-md-4"><label for="doctor">Médecins:</label></div>
                <div class="col-md-8">
              ...
              document.getElementById('doctor').onchange = function updateFees(e) {
                ...
                document.getElementById('docFees').value = selection;
                  ...
                  <div class="col-md-4"><label>Date de rendez-vous</label></div>
                  <div class="col-md-8"><input type="date" class="form-control datepicker" name="appdate"></div><br><br>

                  <div class="col-md-4"><label>Heure de rendez-vous</label></div>
                  <div class="col-md-8">
                  
                    <select name="apptime" class="form-control" id="apptime" required="required">
                      <option value="" disabled selected>Sélectionnez l'heure</option>
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="app-submit" value="Créer une nouvelle entrée" class="btn btn-primary" id="inputbtn">
                  </div>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Les allergies</th>
                    <th scope="col">Prescriptions</th>
                    <th scope="col">Paiement de factures</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                      ...
                      <tr>
                        ...
                        <td>
                          <form method="get">
                              ...
                              <input type = "submit" onclick="alert('Facture payée avec succès');" name ="generate_bill" class = "btn btn-success" value="Payez Facture"/>
                              </a>
                              </td>
                              </form>
